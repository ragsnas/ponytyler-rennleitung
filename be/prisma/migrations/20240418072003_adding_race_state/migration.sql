...
INSERT INTO "new_Race" ("bikeWon", "createdAt", "id", "orderNumber", "person1", "person2", "raced", "showId", "song1Id", "song2Id") SELECT "bikeWon", "createdAt", "id", "orderNumber", "person1", "person2", "raced", "showId", "song1Id", "song2Id" FROM "Race";
DROP TABLE "Race";
