...
exports.RaceModule = void 0;
const common_1 = require("@nestjs/common");
const race_controller_1 = require("./race.controller");
const prisma_api_module_1 = require("../prisma-api/prisma-api.module");
let RaceModule = class RaceModule {
};
exports.RaceModule = RaceModule;
exports.RaceModule = RaceModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_api_module_1.PrismaApiModule],
        controllers: [race_controller_1.RaceController],
    })
], RaceModule);
